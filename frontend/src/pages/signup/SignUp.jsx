		...
		<div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
			<div className='w-full p-6 rounded-lg shadow-md bg-green-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
				...
				<form onSubmit={handleSubmit}>
					...
					<Link
						to={"/login"}
						className='text-sm hover:underline hover:text-green-700 mt-2 inline-block text-red-700'
						href='#' 
					>
					...
					<div>
						<button className='btn btn-block btn-sm mt-2 border border-slate-900' disabled={loading}>
